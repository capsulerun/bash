...
describe('node command', () => {
    ...
    it('should evaluate inline code correctly with -e', async () => {
        ...
        const ctx = createMockContext(['-e', 'console.log("inline output")'], {}, { executeCode: executeCodeMock });
    ...
    it('should execute a script file with executeFile', async () => {
        ...
        const ctx = createMockContext(['script.js', 'arg1', 'arg2'], {}, { 
        ...
        expect(executeFileMock).toHaveBeenCalledWith(expect.anything(), '/workspace/script.js', ['arg1', 'arg2']);
    });
